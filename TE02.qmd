...
To support the development of the Shiny application, our group selected packages based on clarity of output, ease of integration with Shiny, interpretability and suitability for the project scope.
